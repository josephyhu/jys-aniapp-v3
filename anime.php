...
<main>
    ...
    <?php
        ...
        if (!empty($data)) {
            ...
            ?>
                <td><a href="anime.php?id=<?php echo $$elatedMedia[$i]['node']['id']; ?>"></a><img src="<?php echo $relatedMedia[$i]['node']['coverImage']['medium']; ?>" alt="cover" title='<?php echo $relatedMedia[$i]["node"]["title"]["romaji"] . "\n" . $relatedMedia[$i]["relationType"]; ?>'></a></td>
            <?php
