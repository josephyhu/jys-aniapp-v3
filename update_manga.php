...
<?php
    ...
    <form method="post">
        ...
        <input type="number" id="progress" name="progress" value="<?php echo (!empty($data['progress'])) ? $data['progress'] : 0; ?>">
    ...
    <?php 
        ...
        if (update_manga($_SESSION['accessToken'], $id, $status, $startedAt, $completedAt, $score, $progress, $progressVolumes)) {
