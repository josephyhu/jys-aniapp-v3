...
<main>
    ...
    if (!empty($data)) {
        ...
        ?>
            <td><a href="anime.php?id=<?php echo $data[$i]['media']['id']; ?>"><img src="<?php echo $data[$i]['media']['coverImage']['medium']; ?>" alt='cover' title="<?php echo $data[$i]['media']['title']['romaji']; ?>"></a></td>
        <?php
            if (substr($i, -1) == 9) {
                echo '</tr><tr>';
            }
